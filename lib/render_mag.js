...
function css() {
  ...
  *{margin:0;padding:0;box-sizing:border-box;font-family:'Noto Sans CJK KR','Noto Sans KR',sans-serif;word-break:keep-all;}
  ...
  .sticker{position:absolute;top:470px;right:70px;z-index:5;background:#fff;color:#12284B;font-size:33px;font-weight:800;line-height:1.26;padding:20px 30px;border-radius:26px 26px 26px 6px;transform:rotate(4deg);box-shadow:0 14px 30px rgba(0,0,0,0.42);max-width:470px;text-align:center;}
...
function magPages(topic, nextTopic, handle, photos) {
  ...
  pages.push({ name: 'slide01.png', html: `<div class="slide">
    ...
    ${topic.sticker ? `<div class="sticker">${topic.sticker}</div>` : ''}
