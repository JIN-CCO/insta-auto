...
function css() {
  ...
  *{margin:0;padding:0;box-sizing:border-box;font-family:'Noto Sans CJK KR','Noto Sans KR',sans-serif;word-break:keep-all;}
  ...
  .nq{font-size:70px;font-weight:800;line-height:1.24;letter-spacing:-3px;margin-top:36px;}
  ...
  .next .foot{position:static;margin-top:56px;padding:0;color:rgba(255,255,255,0.75);}
  `;
}
...
function magPages(topic, nextTopic, handle, photos) {
  ...
  if (nextTopic) {
    ...
    pages.push({ name: `slide${String(n).padStart(2, '0')}.png`, html: `<div class="slide">
      <div class="p-top">${photoDiv(uri(photos.next), '다음 편')}</div>
      <div class="p-body">
        <span class="chip-l">다음 편</span>
        <div class="bh">${nextTopic.coverQ}</div>
        <div class="nsub2">더 많은 내용이 궁금하다면?</div>
        <div class="nfollow2">계정 팔로우!</div>
        ${foot(handle, null, null)}
      </div>
    </div>` });
  }
